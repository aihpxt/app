...
from app.core.database_pool import DatabaseManager
from app.models.user import User, Base
from sqlalchemy import text

RESULT_FILE = os.path.join(SCRIPT_DIR, "db_fix_result.json")
result = {"steps": []}
...
try:
    ...
    import traceback
    log("step_1_db_manager", False, error=f"{type(e).__name__}: {e}\n{traceback.format_exc()}")
