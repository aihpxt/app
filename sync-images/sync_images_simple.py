...
CONFIG = {
    ...
    'IMAGE_FOLDER': r'E:\aiphxt-app\frontend\public\images',
    # Database path
...
def create_image_table_if_not_exists(cursor):
    create_table_query = f"""
        CREATE TABLE IF NOT EXISTS {CONFIG['TABLE_NAME']} (
            ...
            width INTEGER DEFAULT 0,                    -- Image width (px)
            height INTEGER DEFAULT 0,                   -- Image height (px)
...
# --------------------------
# Helper 3: Extract image metadata
# --------------------------
def extract_all_image_metadata(image_files):
    ...
    for img in image_files:
        ...
        format = 'jpeg' if img['name'].endswith('.jpg') else 'unknown'
        ...
        result.append({
            ...
            'width': 0,  # Placeholder since we don't have PIL
            'height': 0,  # Placeholder since we don't have PIL
            'format': format
        })
    return result
